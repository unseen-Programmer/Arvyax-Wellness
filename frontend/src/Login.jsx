const Login = () => (
  <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#A7D6D0] to-[#D1E8E2] px-4">
    <div className="bg-white/50 backdrop-blur-lg rounded-3xl shadow-2xl p-10 w-full max-w-md text-center animate-fadeInUp">
      <h2 className="text-3xl font-bold text-[#256363] mb-4">Login</h2>
      <p className="mb-6 text-gray-700">Welcome back! Please log in to your account.</p>
      <input
        type="text"
        placeholder="Email"
      ...
      />
      <button className="bg-[#256363] text-white font-bold py-2 px-6 rounded-full hover:bg-[#1a4f4f] transition duration-300">
        Login
      </button>
    </div>
  </div>
